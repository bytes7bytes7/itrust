...
part of 'friend_bids_provider.dart';
...
class _ProdFriendBidsProvider implements ProdFriendBidsProvider {
  ...
  Future<JsonEitherWrapper<ProblemDetails, FriendBidsAmountResponse>>
      getFriendBidsAmount() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<
        JsonEitherWrapper<ProblemDetails, FriendBidsAmountResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value =
        JsonEitherWrapper<ProblemDetails, FriendBidsAmountResponse>.fromJson(
            _result.data!);
    return value;
  }
