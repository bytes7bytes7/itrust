...
mixin _$RegisterStore on _RegisterStore, Store {
  ...
  late final _$_isLoadingAtom =
      Atom(name: '_RegisterStore._isLoading', context: context);
  ...
  late final _$_errorAtom =
      Atom(name: '_RegisterStore._error', context: context);
  ...
  late final _$firstNameAtom =
      Atom(name: '_RegisterStore.firstName', context: context);
  ...
  late final _$lastNameAtom =
      Atom(name: '_RegisterStore.lastName', context: context);
