    ...
    return _then(_$EndUserInfoVM(
      user: null == user
          ...
          : user // ignore: cast_nullable_to_non_nullable
              as EndUserVM,
      friendsAmountWithoutMe: null == friendsAmountWithoutMe
          ? _value.friendsAmountWithoutMe
          : friendsAmountWithoutMe // ignore: cast_nullable_to_non_nullable
              as String,
      friendsAmountWithMe: null == friendsAmountWithMe
      ...
      subscribersAmountWithoutMe: null == subscribersAmountWithoutMe
          ...
          : subscribersAmountWithoutMe // ignore: cast_nullable_to_non_nullable
              as String,
      subscribersAmountWithMe: null == subscribersAmountWithMe
...
class _$EndUserInfoVM implements EndUserInfoVM {
  ...
  @override
  final String friendsAmountWithoutMe;
  @override
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.friendsAmountWithoutMe, friendsAmountWithoutMe) ||
...
class _$StaffUserInfoVM implements StaffUserInfoVM {
  const _$StaffUserInfoVM({required this.user});
