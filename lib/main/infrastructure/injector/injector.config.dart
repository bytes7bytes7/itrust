...
import 'package:go_router/go_router.dart' as _i41;
...
import 'package:itrust/features/connection/application/stores/connection/connection_store.dart'
    as _i15;
import 'package:itrust/features/features.dart' as _i42;
...
import 'package:itrust/main/application/coordinators/home_coordinator.dart'
    as _i43;
import 'package:itrust/main/application/stores/home/home_store.dart' as _i45;
...
import '../router/router.dart' as _i70;
import '../third_party/firebase_module.dart' as _i71;
...
Future<_i1.GetIt> init(
  ...
  gh.singleton<
          _i31.TwoEntitiesToViewModelMapper<_i13.Comment, _i31.User,
              _i32.CommentVM>>(
      _i33.CommentMapper(dateFormatProvider: gh<_i31.FormattedDateProvider>()));
  gh.singleton<
          _i34.TwoEntitiesToViewModelMapper<_i6.Post, _i6.User, _i34.PostVM>>(
      _i35.PostMapper(formattedDateProvider: gh<_i34.FormattedDateProvider>()));
  gh.singleton<_i6.UserRepository>(
      _i36.ProdUserRepository(firebaseAuth: gh<_i20.FirebaseAuth>()));
  await gh.singletonAsync<_i6.AuthService>(
    () {
      final i = _i37.ProdAuthService(firebaseAuth: gh<_i20.FirebaseAuth>());
      return i.init().then((_) => i);
    },
    preResolve: true,
  );
  gh.singleton<_i38.AuthStringProvider>(_i39.ProdAuthStringProvider(
      navigatorKey: gh<_i40.GlobalKey<_i40.NavigatorState>>()));
  gh.singleton<_i41.GoRouter>(routerModule.router(
    gh<_i23.GlobalKey<_i23.NavigatorState>>(),
    gh<_i42.AuthService>(),
  ));
  gh.singleton<_i43.HomeCoordinator>(
    _i44.ProdHomeCoordinator(goRouter: gh<_i41.GoRouter>())..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i45.HomeStore>(
      () => _i45.HomeStore(homeCoordinator: gh<_i43.HomeCoordinator>()));
  gh.singleton<_i42.MenuCoordinator>(
      _i46.ProdMenuCoordinator(goRouter: gh<_i41.GoRouter>()));
  gh.factory<_i47.MenuStore>(
      () => _i47.MenuStore(menuCoordinator: gh<_i48.MenuCoordinator>()));
  gh.singleton<_i42.PostCoordinator>(
      _i49.ProdPostCoordinator(goRouter: gh<_i41.GoRouter>()));
  gh.singleton<_i42.RulesCoordinator>(
      _i50.ProdRulesCoordinator(goRouter: gh<_i41.GoRouter>()));
  ...
  gh.singleton<_i42.SettingsCoordinator>(
      _i54.ProdSettingsCoordinator(goRouter: gh<_i41.GoRouter>()));
  ...
  gh.singleton<_i42.AuthCoordinator>(
    _i57.ProdAuthCoordinator(
      goRouter: gh<_i41.GoRouter>(),
  ...
  gh.factory<_i58.AuthStore>(() => _i58.AuthStore(
        ...
        authStringProvider: gh<_i38.AuthStringProvider>(),
      ));
  gh.singleton<_i42.CommentCoordinator>(
      _i60.ProdCommentCoordinator(goRouter: gh<_i41.GoRouter>()));
  gh.factory<_i61.CommentReplyStore>(() => _i61.CommentReplyStore(
        commentService: gh<_i13.CommentService>(),
        commentCoordinator: gh<_i62.CommentCoordinator>(),
        commentMapper: gh<
            _i31.TwoEntitiesToViewModelMapper<_i13.Comment, _i31.User,
                _i32.CommentVM>>(),
      ));
  gh.factory<_i63.CommentStore>(() => _i63.CommentStore(
        commentReplyStore: gh<_i61.CommentReplyStore>(),
        commentService: gh<_i13.CommentService>(),
        commentCoordinator: gh<_i62.CommentCoordinator>(),
        commentMapper: gh<
            _i31.TwoEntitiesToViewModelMapper<_i13.Comment, _i31.User,
  ...
  gh.singleton<_i42.FeedCoordinator>(
      _i64.ProdFeedCoordinator(goRouter: gh<_i41.GoRouter>()));
  gh.factory<_i65.FeedStore>(() => _i65.FeedStore(
        categoryStore: gh<_i5.CategoryStore>(),
        feedService: gh<_i18.FeedService>(),
        feedCoordinator: gh<_i66.FeedCoordinator>(),
        postMapper: gh<
            _i31.TwoEntitiesToViewModelMapper<_i31.Post, _i31.User,
                _i31.PostVM>>(),
      ));
  gh.factory<_i67.PostCommentStore>(() => _i67.PostCommentStore(
        commentService: gh<_i13.CommentService>(),
        commentCoordinator: gh<_i62.CommentCoordinator>(),
        commentMapper: gh<
            _i31.TwoEntitiesToViewModelMapper<_i13.Comment, _i31.User,
  ...
  gh.factory<_i68.PostStore>(() => _i68.PostStore(
        postCommentStore: gh<_i67.PostCommentStore>(),
        postService: gh<_i27.PostService>(),
        postCoordinator: gh<_i69.PostCoordinator>(),
        postMapper: gh<
            _i31.TwoEntitiesToViewModelMapper<_i31.Post, _i31.User,
                _i31.PostVM>>(),
      ));
...
class _$RouterModule extends _i70.RouterModule {}
