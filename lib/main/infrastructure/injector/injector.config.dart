...
import 'package:go_router/go_router.dart' as _i92;
...
import 'package:itrust/features/common/application/providers/formatted_date_provider.dart'
    as _i22;
import 'package:itrust/features/common/common.dart' as _i82;
...
import 'package:itrust/features/connection/application/stores/connection/connection_store.dart'
    as _i14;
import 'package:itrust/features/features.dart' as _i93;
...
import 'package:itrust/features/feed/domain/services/category_service.dart'
    as _i3;
import 'package:itrust/features/feed/domain/services/feed_service.dart' as _i80;
...
import 'package:itrust/main/application/coordinators/home_coordinator.dart'
    as _i94;
import 'package:itrust/main/application/stores/home/home_store.dart' as _i96;
...
import '../../../env/env_module.dart' as _i125;
import '../../../features/common/infrastructure/third_party/mapster_module.dart'
    as _i126;
import '../router/router.dart' as _i127;
import '../third_party/device_info_plus_module.dart' as _i128;
import '../third_party/dio_module.dart' as _i129;
import '../third_party/secure_storage_module.dart' as _i130;
...
Future<_i1.GetIt> init(
  ...
  gh.singleton<_i25.JsonConverter<_i31.ProblemDetails, Map<String, Object?>>>(
  ...
  gh.singleton<_i25.JsonConverter<_i35.LogOutResponse, Map<String, Object?>>>(
  ...
  gh.singleton<_i61.BeautifiedNumberProvider>(_i72.ProdBeautifiedNumberProvider(
      suffixNumberProvider: gh<_i61.SuffixNumberProvider>()));
  gh.singleton<_i73.CategoryStringProvider>(_i74.ProdCategoryStringProvider(
      navigatorKey: gh<_i42.GlobalKey<_i42.NavigatorState>>()));
  gh.singleton<_i75.CommentReplyStringProvider>(
      _i76.ProdCommentReplyStringProvider(
          navigatorKey: gh<_i42.GlobalKey<_i42.NavigatorState>>()));
  gh.singleton<_i77.CommentStringProvider>(_i78.ProdCommentStringProvider(
      navigatorKey: gh<_i42.GlobalKey<_i42.NavigatorState>>()));
  gh.singleton<_i79.CommonMapsterRegistrar>(
      _i79.CommonMapsterRegistrar(gh<_i43.Mapster>())..register());
  gh.singleton<_i80.FeedService>(_i81.ProdFeedService(
    postRepository: gh<_i82.PostRepository>(),
    endUserRepository: gh<_i82.EndUserRepository>(),
  ));
  gh.singleton<_i83.FeedStringProvider>(_i84.ProdFeedStringProvider(
      navigatorKey: gh<_i42.GlobalKey<_i42.NavigatorState>>()));
  gh.singleton<_i5.ServerAvailabilityProvider>(
      _i85.ProdServerAvailabilityProvider(gh<_i58.ServerSettings>()));
  await gh.singletonAsync<_i86.AuthService>(
    () {
      final i = _i86.AuthService(
        serverAvailabilityProvider: gh<_i87.ServerAvailabilityProvider>(),
        authProvider: gh<_i69.AuthProvider>(),
        tokenService: gh<_i88.TokenService>(),
        endUserRepository: gh<_i89.EndUserRepository>(),
        authExceptionProvider: gh<_i90.AuthExceptionProvider>(),
        deviceInfoService: gh<_i91.DeviceInfoService>(),
      );
  ...
  gh.singleton<_i92.GoRouter>(routerModule.router(
    gh<_i24.GlobalKey<_i24.NavigatorState>>(),
    gh<_i93.AuthService>(),
  ));
  gh.singleton<_i94.HomeCoordinator>(
    _i95.ProdHomeCoordinator(goRouter: gh<_i92.GoRouter>())..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i96.HomeStore>(
      () => _i96.HomeStore(homeCoordinator: gh<_i94.HomeCoordinator>()));
  gh.singleton<_i93.LogInCoordinator>(
    _i97.ProdLogInCoordinator(
      goRouter: gh<_i92.GoRouter>(),
      authService: gh<_i93.AuthService>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i98.LogInStore>(() => _i98.LogInStore(
        authService: gh<_i5.AuthService>(),
        logInCoordinator: gh<_i99.LogInCoordinator>(),
        logInStringProvider: gh<_i40.LogInStringProvider>(),
      ));
  gh.singleton<_i93.MenuCoordinator>(
      _i100.ProdMenuCoordinator(goRouter: gh<_i92.GoRouter>()));
  gh.singleton<_i101.MenuStore>(
      _i101.MenuStore(menuCoordinator: gh<_i102.MenuCoordinator>()));
  gh.singleton<_i93.PostCoordinator>(
      _i103.ProdPostCoordinator(goRouter: gh<_i92.GoRouter>()));
  gh.singleton<_i93.RegisterCoordinator>(
    _i104.ProdRegisterCoordinator(
      goRouter: gh<_i92.GoRouter>(),
      authService: gh<_i93.AuthService>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i105.RegisterStore>(() => _i105.RegisterStore(
        authService: gh<_i5.AuthService>(),
        registerCoordinator: gh<_i106.RegisterCoordinator>(),
        registerStringProvider: gh<_i52.RegisterStringProvider>(),
      ));
  gh.singleton<_i93.RulesCoordinator>(
      _i107.ProdRulesCoordinator(goRouter: gh<_i92.GoRouter>()));
  gh.factory<_i108.RulesStore>(() => _i108.RulesStore(
        rulesService: gh<_i109.RulesService>(),
        rulesCoordinator: gh<_i110.RulesCoordinator>(),
      ));
  gh.singleton<_i93.SettingsCoordinator>(
      _i111.ProdSettingsCoordinator(goRouter: gh<_i92.GoRouter>()));
  gh.factory<_i112.SettingsStore>(() => _i112.SettingsStore(
        authService: gh<_i82.AuthService>(),
        settingsCoordinator: gh<_i113.SettingsCoordinator>(),
        settingsStringProvider: gh<_i59.SettingsStringProvider>(),
      ));
  gh.singleton<_i93.CommentCoordinator>(
      _i114.ProdCommentCoordinator(goRouter: gh<_i92.GoRouter>()));
  gh.factory<_i115.CommentReplyStore>(() => _i115.CommentReplyStore(
        commentService: gh<_i12.CommentService>(),
        commentCoordinator: gh<_i116.CommentCoordinator>(),
        commentReplyStringProvider: gh<_i75.CommentReplyStringProvider>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.factory<_i117.CommentStore>(() => _i117.CommentStore(
        commentReplyStore: gh<_i115.CommentReplyStore>(),
        commentService: gh<_i12.CommentService>(),
        commentCoordinator: gh<_i116.CommentCoordinator>(),
        commentStringProvider: gh<_i77.CommentStringProvider>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.singleton<_i93.FeedCoordinator>(
      _i118.ProdFeedCoordinator(goRouter: gh<_i92.GoRouter>()));
  gh.factory<_i119.FeedStore>(() => _i119.FeedStore(
        feedService: gh<_i80.FeedService>(),
        feedCoordinator: gh<_i120.FeedCoordinator>(),
        feedStringProvider: gh<_i83.FeedStringProvider>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.factory<_i121.PostCommentStore>(() => _i121.PostCommentStore(
        commentService: gh<_i12.CommentService>(),
        commentCoordinator: gh<_i116.CommentCoordinator>(),
        postCommentStringProvider: gh<_i44.PostCommentStringProvider>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.factory<_i122.PostStore>(() => _i122.PostStore(
        postCommentStore: gh<_i121.PostCommentStore>(),
        postService: gh<_i48.PostService>(),
        postCoordinator: gh<_i123.PostCoordinator>(),
        postStringProvider: gh<_i50.PostStringProvider>(),
        mapster: gh<_i43.Mapster>(),
      ));
  gh.singleton<_i124.CategoryStore>(_i124.CategoryStore(
    feedStore: gh<_i119.FeedStore>(),
    categoryService: gh<_i3.CategoryService>(),
    categoryStringProvider: gh<_i73.CategoryStringProvider>(),
  ));
  return getIt;
}

class _$EnvModule extends _i125.EnvModule {}

class _$MapsterModule extends _i126.MapsterModule {}

class _$RouterModule extends _i127.RouterModule {}

class _$DeviceInfoPlusModule extends _i128.DeviceInfoPlusModule {}

class _$DioModule extends _i129.DioModule {}

class _$SecureStorageModule extends _i130.SecureStorageModule {}
