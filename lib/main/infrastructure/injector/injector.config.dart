...
import 'package:go_router/go_router.dart' as _i126;
...
import 'package:itrust/features/common/application/providers/formatted_date_provider.dart'
    as _i27;
import 'package:itrust/features/common/common.dart' as _i42;
...
import 'package:itrust/features/connection/application/stores/connection/connection_store.dart'
    as _i18;
import 'package:itrust/features/features.dart' as _i127;
...
import 'package:itrust/features/post/domain/dto/post_response/post_response.dart'
    as _i35;
import 'package:itrust/features/post/domain/providers/post_provider.dart'
    as _i112;
import 'package:itrust/features/post/domain/services/post_service.dart'
    as _i120;
...
import 'package:itrust/features/post/infrastructure/app_providers/post_string_provider.dart'
    as _i67;
import 'package:itrust/features/post/infrastructure/domain_providers/post_provider/post_provider.dart'
    as _i113;
import 'package:itrust/features/post/infrastructure/json_converters/post_response_json_converter.dart'
    as _i36;
...
import 'package:itrust/features/settings/application/stores/settings/settings_store.dart'
    as _i146;
import 'package:itrust/features/settings/domain/domain.dart' as _i153;
...
import 'package:itrust/main/application/coordinators/home_coordinator.dart'
    as _i128;
import 'package:itrust/main/application/stores/home/home_store.dart' as _i130;
...
import 'package:problem_details/problem_details.dart' as _i39;

import '../../../env/env_module.dart' as _i169;
import '../../../features/common/infrastructure/third_party/mapster_module.dart'
    as _i170;
import '../router/router.dart' as _i171;
import '../third_party/device_info_plus_module.dart' as _i172;
import '../third_party/dio_module.dart' as _i173;
import '../third_party/secure_storage_module.dart' as _i174;
...
Future<_i1.GetIt> init(
  ...
  gh.singleton<_i30.JsonConverter<_i31.LogInResponse, Map<String, Object?>>>(
  ...
  gh.singleton<_i30.JsonConverter<_i35.PostResponse, Map<String, Object?>>>(
      _i36.PostResponseJsonConverter());
  gh.singleton<
          _i30.JsonConverter<_i37.VerifyTokenResponse, Map<String, Object?>>>(
      _i38.VerifyTokenResponseJsonConverter());
  gh.singleton<_i30.JsonConverter<_i39.ProblemDetails, Map<String, Object?>>>(
      _i40.ProblemDetailsJsonConverter());
  gh.singleton<
          _i41.JsonConverter<_i42.RefreshTokenResponse, Map<String, Object?>>>(
      _i43.RefreshTokenResponseJsonConverter());
  gh.singleton<
          _i30.JsonConverter<_i44.GetUserByIDResponse, Map<String, Object?>>>(
      _i45.GetUserByIDResponseJsonConverter());
  gh.singleton<_i41.JsonConverter<_i46.RegisterResponse, Map<String, Object?>>>(
      _i47.RegisterResponseJsonConverter());
  gh.singleton<_i30.JsonConverter<_i48.GetFeedResponse, Map<String, Object?>>>(
      _i49.GetFeedResponseJsonConverter());
  gh.singleton<
          _i30.JsonConverter<_i50.GetDevicesResponse, Map<String, Object?>>>(
      _i51.GetDevicesResponseJsonConverter());
  gh.singleton<
          _i30.JsonConverter<_i52.ChangePersonalInfoResponse,
              Map<String, Object?>>>(
  ...
  gh.singleton<_i80.SuffixNumberProvider>(_i81.ProdSuffixNumberProvider(
      navigatorKey: gh<_i59.GlobalKey<_i59.NavigatorState>>()));
  gh.singleton<_i8.TokenService>(_i82.ProdTokenService(
    dio: gh<_i23.Dio>(),
  ...
  gh.singleton<_i120.PostService>(_i120.PostService(
    keepFreshTokenService: gh<_i42.KeepFreshTokenService>(),
  ...
  gh.singleton<_i125.FeedService>(_i125.FeedService(
    keepFreshTokenService: gh<_i42.KeepFreshTokenService>(),
    feedProvider: gh<_i103.FeedProvider>(),
  ));
  gh.singleton<_i126.GoRouter>(routerModule.router(
    gh<_i29.GlobalKey<_i29.NavigatorState>>(),
    gh<_i127.AuthService>(),
  ));
  gh.singleton<_i128.HomeCoordinator>(
    _i129.ProdHomeCoordinator(goRouter: gh<_i126.GoRouter>())..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i130.HomeStore>(
      () => _i130.HomeStore(homeCoordinator: gh<_i128.HomeCoordinator>()));
  gh.singleton<_i127.LogInCoordinator>(
    _i131.ProdLogInCoordinator(
      goRouter: gh<_i126.GoRouter>(),
      authStatusProvider: gh<_i127.AuthStatusProvider>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i132.LogInStore>(() => _i132.LogInStore(
        authService: gh<_i8.AuthService>(),
        logInCoordinator: gh<_i133.LogInCoordinator>(),
        logInStringProvider: gh<_i57.LogInStringProvider>(),
      ));
  gh.singleton<_i127.MenuCoordinator>(
      _i134.ProdMenuCoordinator(goRouter: gh<_i126.GoRouter>()));
  gh.singleton<_i135.MenuStore>(
      _i135.MenuStore(menuCoordinator: gh<_i136.MenuCoordinator>()));
  gh.singleton<_i127.PostCoordinator>(
      _i137.ProdPostCoordinator(goRouter: gh<_i126.GoRouter>()));
  gh.singleton<_i127.RegisterCoordinator>(
    _i138.ProdRegisterCoordinator(
      goRouter: gh<_i126.GoRouter>(),
      authStatusProvider: gh<_i127.AuthStatusProvider>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i139.RegisterStore>(() => _i139.RegisterStore(
        authService: gh<_i8.AuthService>(),
        registerCoordinator: gh<_i140.RegisterCoordinator>(),
        registerStringProvider: gh<_i68.RegisterStringProvider>(),
      ));
  gh.singleton<_i127.RulesCoordinator>(
      _i141.ProdRulesCoordinator(goRouter: gh<_i126.GoRouter>()));
  gh.factory<_i142.RulesStore>(() => _i142.RulesStore(
        rulesService: gh<_i143.RulesService>(),
        rulesCoordinator: gh<_i144.RulesCoordinator>(),
      ));
  gh.singleton<_i127.SettingsCoordinator>(
      _i145.ProdSettingsCoordinator(goRouter: gh<_i126.GoRouter>()));
  gh.singleton<_i146.SettingsStore>(_i146.SettingsStore(
    authService: gh<_i42.AuthService>(),
    settingsCoordinator: gh<_i147.SettingsCoordinator>(),
    settingsStringProvider: gh<_i76.SettingsStringProvider>(),
    accountService: gh<_i122.AccountService>(),
    mapster: gh<_i60.Mapster>(),
  ));
  gh.singleton<_i127.AccountSettingsCoordinator>(
      _i148.ProdAccountSettingsCoordinator(goRouter: gh<_i126.GoRouter>()));
  gh.factory<_i149.AccountSettingsStore>(() => _i149.AccountSettingsStore(
      accountSettingsCoordinator: gh<_i150.AccountSettingsCoordinator>()));
  gh.singleton<_i127.ChangePersonalInfoCoordinator>(
      _i151.ProdChangePersonalInfoCoordinator(goRouter: gh<_i126.GoRouter>()));
  gh.factory<_i152.ChangePersonalInfoStore>(() => _i152.ChangePersonalInfoStore(
        accountService: gh<_i153.AccountService>(),
        changePersonalInfoCoordinator:
            gh<_i154.ChangePersonalInfoCoordinator>(),
        changePersonalInfoStringProvider:
            gh<_i96.ChangePersonalInfoStringProvider>(),
      ));
  gh.singleton<_i127.CommentCoordinator>(
      _i155.ProdCommentCoordinator(goRouter: gh<_i126.GoRouter>()));
  gh.factory<_i156.CommentReplyStore>(() => _i156.CommentReplyStore(
        commentService: gh<_i16.CommentService>(),
        commentCoordinator: gh<_i157.CommentCoordinator>(),
        commentReplyStringProvider: gh<_i98.CommentReplyStringProvider>(),
        mapster: gh<_i60.Mapster>(),
      ));
  gh.factory<_i158.CommentStore>(() => _i158.CommentStore(
        commentReplyStore: gh<_i156.CommentReplyStore>(),
        commentService: gh<_i16.CommentService>(),
        commentCoordinator: gh<_i157.CommentCoordinator>(),
        commentStringProvider: gh<_i100.CommentStringProvider>(),
        mapster: gh<_i60.Mapster>(),
      ));
  gh.singleton<_i159.DevicesCoordinator>(
      _i160.ProdDevicesCoordinator(goRouter: gh<_i126.GoRouter>()));
  gh.singleton<_i161.DevicesStore>(_i161.DevicesStore(
    devicesCoordinator: gh<_i159.DevicesCoordinator>(),
    accountService: gh<_i122.AccountService>(),
    mapster: gh<_i60.Mapster>(),
  ));
  gh.singleton<_i127.FeedCoordinator>(
      _i162.ProdFeedCoordinator(goRouter: gh<_i126.GoRouter>()));
  gh.factory<_i163.FeedStore>(() => _i163.FeedStore(
        feedService: gh<_i125.FeedService>(),
        userService: gh<_i42.UserService>(),
        feedCoordinator: gh<_i164.FeedCoordinator>(),
        feedStringProvider: gh<_i105.FeedStringProvider>(),
        mapster: gh<_i60.Mapster>(),
      ));
  gh.factory<_i165.PostCommentStore>(() => _i165.PostCommentStore(
        commentService: gh<_i16.CommentService>(),
        commentCoordinator: gh<_i157.CommentCoordinator>(),
        postCommentStringProvider: gh<_i61.PostCommentStringProvider>(),
        mapster: gh<_i60.Mapster>(),
      ));
  gh.factory<_i166.PostStore>(() => _i166.PostStore(
        postCommentStore: gh<_i165.PostCommentStore>(),
        postService: gh<_i120.PostService>(),
        postCoordinator: gh<_i167.PostCoordinator>(),
        postStringProvider: gh<_i66.PostStringProvider>(),
        mapster: gh<_i60.Mapster>(),
      ));
  gh.singleton<_i168.CategoryStore>(_i168.CategoryStore(
    feedStore: gh<_i163.FeedStore>(),
...
class _$EnvModule extends _i169.EnvModule {}

class _$MapsterModule extends _i170.MapsterModule {}

class _$RouterModule extends _i171.RouterModule {}

class _$DeviceInfoPlusModule extends _i172.DeviceInfoPlusModule {}

class _$DioModule extends _i173.DioModule {}

class _$SecureStorageModule extends _i174.SecureStorageModule {}
