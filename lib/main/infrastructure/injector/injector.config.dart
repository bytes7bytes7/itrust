...
import 'package:go_router/go_router.dart' as _i66;
...
import 'package:itrust/features/auth/application/stores/rules/rules_store.dart'
    as _i82;
import 'package:itrust/features/auth/auth.dart' as _i37;
...
import 'package:itrust/features/chat_list/application/stores/chat_list/chat_list_store.dart'
    as _i7;
import 'package:itrust/features/common/application/application.dart' as _i40;
...
import 'package:itrust/features/connection/application/stores/connection/connection_store.dart'
    as _i14;
import 'package:itrust/features/features.dart' as _i67;
...
import 'package:itrust/features/feed/domain/services/category_service.dart'
    as _i3;
import 'package:itrust/features/feed/domain/services/feed_service.dart' as _i61;
...
import 'package:itrust/features/post/domain/services/post_service.dart' as _i31;
...
import 'package:itrust/main/application/coordinators/home_coordinator.dart'
    as _i68;
import 'package:itrust/main/application/stores/home/home_store.dart' as _i70;
...
import 'package:itrust/main/infrastructure/json_converters/problem_details_json_converter.dart'
    as _i35;
import 'package:itrust/utils/server_settings.dart' as _i39;
import 'package:itrust/utils/utils.dart' as _i48;
...
import '../../../features/common/infrastructure/third_party/mapster_module.dart'
    as _i100;
import '../router/router.dart' as _i101;
import '../third_party/dio_module.dart' as _i102;
...
Future<_i1.GetIt> init(
  ...
  gh.singleton<_i29.PostMapsterRegistrar>(
      _i29.PostMapsterRegistrar(gh<_i25.Mapster>())..register());
  gh.singleton<_i5.PostRepository>(_i30.ProdPostRepository());
  gh.singleton<_i31.PostService>(
    _i32.TestPostService(),
    registerFor: {_test},
  );
  gh.singleton<_i33.PostStringProvider>(_i34.ProdPostStringProvider(
      navigatorKey: gh<_i28.GlobalKey<_i28.NavigatorState>>()));
  gh.singleton<_i35.ProblemDetailsJsonConverter>(
      _i35.ProblemDetailsJsonConverter());
  gh.singleton<_i36.RegisterResponseJsonConverter>(
      _i36.RegisterResponseJsonConverter());
  gh.singleton<_i37.RulesService>(
    _i38.TestRulesService(),
    registerFor: {_test},
  );
  gh.singleton<_i39.ServerSettings>(envModule.serverSettings);
  gh.singleton<_i40.SuffixNumberProvider>(_i41.ProdSuffixNumberProvider(
      navigatorKey: gh<_i28.GlobalKey<_i28.NavigatorState>>()));
  gh.singleton<_i42.UserInfoService>(_i43.TestUserService());
  gh.singleton<_i44.UserInfoStringProvider>(_i45.ProdUserInfoStringProvider(
      navigatorKey: gh<_i28.GlobalKey<_i28.NavigatorState>>()));
  gh.singleton<_i46.AuthProvider>(_i47.ProdAuthProvider(
    gh<_i17.Dio>(),
    gh<_i48.ServerSettings>(),
  ));
  await gh.singletonAsync<_i49.AuthService>(
    () {
      final i = _i49.AuthService(
        authProvider: gh<_i46.AuthProvider>(),
  ...
  gh.singleton<_i51.AuthStringProvider>(_i52.ProdAuthStringProvider(
      navigatorKey: gh<_i28.GlobalKey<_i28.NavigatorState>>()));
  gh.singleton<_i40.BeautifiedNumberProvider>(_i53.ProdBeautifiedNumberProvider(
      suffixNumberProvider: gh<_i40.SuffixNumberProvider>()));
  gh.singleton<_i54.CategoryStringProvider>(_i55.ProdCategoryStringProvider(
      navigatorKey: gh<_i28.GlobalKey<_i28.NavigatorState>>()));
  gh.singleton<_i56.CommentReplyStringProvider>(
      _i57.ProdCommentReplyStringProvider(
          navigatorKey: gh<_i28.GlobalKey<_i28.NavigatorState>>()));
  gh.singleton<_i58.CommentStringProvider>(_i59.ProdCommentStringProvider(
      navigatorKey: gh<_i28.GlobalKey<_i28.NavigatorState>>()));
  gh.singleton<_i60.CommonMapsterRegistrar>(
      _i60.CommonMapsterRegistrar(gh<_i25.Mapster>())..register());
  gh.singleton<_i61.FeedService>(_i62.ProdFeedService(
    postRepository: gh<_i63.PostRepository>(),
    endUserRepository: gh<_i63.EndUserRepository>(),
  ));
  gh.singleton<_i64.FeedStringProvider>(_i65.ProdFeedStringProvider(
      navigatorKey: gh<_i28.GlobalKey<_i28.NavigatorState>>()));
  gh.singleton<_i66.GoRouter>(routerModule.router(
    gh<_i21.GlobalKey<_i21.NavigatorState>>(),
    gh<_i67.AuthService>(),
  ));
  gh.singleton<_i68.HomeCoordinator>(
    _i69.ProdHomeCoordinator(goRouter: gh<_i66.GoRouter>())..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i70.HomeStore>(
      () => _i70.HomeStore(homeCoordinator: gh<_i68.HomeCoordinator>()));
  gh.singleton<_i67.LogInCoordinator>(
    _i71.ProdLogInCoordinator(
      goRouter: gh<_i66.GoRouter>(),
      authService: gh<_i67.AuthService>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i72.LogInStore>(() => _i72.LogInStore(
        authService: gh<_i5.AuthService>(),
        logInCoordinator: gh<_i73.LogInCoordinator>(),
        authStringProvider: gh<_i51.AuthStringProvider>(),
      ));
  gh.singleton<_i67.MenuCoordinator>(
      _i74.ProdMenuCoordinator(goRouter: gh<_i66.GoRouter>()));
  gh.singleton<_i75.MenuStore>(
      _i75.MenuStore(menuCoordinator: gh<_i76.MenuCoordinator>()));
  gh.singleton<_i67.PostCoordinator>(
      _i77.ProdPostCoordinator(goRouter: gh<_i66.GoRouter>()));
  gh.singleton<_i67.RegisterCoordinator>(
    _i78.ProdRegisterCoordinator(
      goRouter: gh<_i66.GoRouter>(),
      authService: gh<_i67.AuthService>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i79.RegisterStore>(() => _i79.RegisterStore(
        authService: gh<_i5.AuthService>(),
        registerCoordinator: gh<_i80.RegisterCoordinator>(),
        authStringProvider: gh<_i51.AuthStringProvider>(),
      ));
  gh.singleton<_i67.RulesCoordinator>(
      _i81.ProdRulesCoordinator(goRouter: gh<_i66.GoRouter>()));
  gh.factory<_i82.RulesStore>(() => _i82.RulesStore(
        rulesService: gh<_i83.RulesService>(),
        rulesCoordinator: gh<_i84.RulesCoordinator>(),
      ));
  gh.singleton<_i67.SettingsCoordinator>(
      _i85.ProdSettingsCoordinator(goRouter: gh<_i66.GoRouter>()));
  gh.factory<_i86.SettingsStore>(() => _i86.SettingsStore(
        authService: gh<_i63.AuthService>(),
        settingsCoordinator: gh<_i87.SettingsCoordinator>(),
      ));
  gh.singleton<_i67.CommentCoordinator>(
      _i88.ProdCommentCoordinator(goRouter: gh<_i66.GoRouter>()));
  gh.factory<_i89.CommentReplyStore>(() => _i89.CommentReplyStore(
        commentService: gh<_i12.CommentService>(),
        commentCoordinator: gh<_i90.CommentCoordinator>(),
        commentReplyStringProvider: gh<_i56.CommentReplyStringProvider>(),
        mapster: gh<_i25.Mapster>(),
      ));
  gh.factory<_i91.CommentStore>(() => _i91.CommentStore(
        commentReplyStore: gh<_i89.CommentReplyStore>(),
        commentService: gh<_i12.CommentService>(),
        commentCoordinator: gh<_i90.CommentCoordinator>(),
        commentStringProvider: gh<_i58.CommentStringProvider>(),
        mapster: gh<_i25.Mapster>(),
      ));
  gh.singleton<_i67.FeedCoordinator>(
      _i92.ProdFeedCoordinator(goRouter: gh<_i66.GoRouter>()));
  gh.factory<_i93.FeedStore>(() => _i93.FeedStore(
        feedService: gh<_i61.FeedService>(),
        feedCoordinator: gh<_i94.FeedCoordinator>(),
        feedStringProvider: gh<_i64.FeedStringProvider>(),
        mapster: gh<_i25.Mapster>(),
      ));
  gh.factory<_i95.PostCommentStore>(() => _i95.PostCommentStore(
        commentService: gh<_i12.CommentService>(),
        commentCoordinator: gh<_i90.CommentCoordinator>(),
        postCommentStringProvider: gh<_i26.PostCommentStringProvider>(),
        mapster: gh<_i25.Mapster>(),
      ));
  gh.factory<_i96.PostStore>(() => _i96.PostStore(
        postCommentStore: gh<_i95.PostCommentStore>(),
        postService: gh<_i31.PostService>(),
        postCoordinator: gh<_i97.PostCoordinator>(),
        postStringProvider: gh<_i33.PostStringProvider>(),
        mapster: gh<_i25.Mapster>(),
      ));
  gh.singleton<_i98.CategoryStore>(_i98.CategoryStore(
    feedStore: gh<_i93.FeedStore>(),
    categoryService: gh<_i3.CategoryService>(),
    categoryStringProvider: gh<_i54.CategoryStringProvider>(),
  ));
  return getIt;
}
...
class _$MapsterModule extends _i100.MapsterModule {}

class _$RouterModule extends _i101.RouterModule {}
