...
import 'package:go_router/go_router.dart' as _i123;
...
import 'package:itrust/features/connection/application/stores/connection/connection_store.dart'
    as _i18;
import 'package:itrust/features/features.dart' as _i124;
...
import 'package:itrust/features/settings/application/stores/settings/settings_store.dart'
    as _i143;
import 'package:itrust/features/settings/domain/domain.dart' as _i150;
...
import 'package:itrust/main/application/coordinators/home_coordinator.dart'
    as _i125;
import 'package:itrust/main/application/stores/home/home_store.dart' as _i127;
...
import 'package:json_annotation/json_annotation.dart' as _i43;
import 'package:mapster/mapster.dart' as _i58;
import 'package:problem_details/problem_details.dart' as _i39;

import '../../../env/env_module.dart' as _i166;
import '../../../features/common/infrastructure/third_party/mapster_module.dart'
    as _i167;
import '../router/router.dart' as _i168;
import '../third_party/device_info_plus_module.dart' as _i169;
import '../third_party/dio_module.dart' as _i170;
import '../third_party/secure_storage_module.dart' as _i171;
...
Future<_i1.GetIt> init(
  ...
  gh.singleton<
          _i30.JsonConverter<_i31.GetUserByIDResponse, Map<String, Object?>>>(
      _i32.GetUserByIDResponseJsonConverter());
  gh.singleton<_i30.JsonConverter<_i33.GetFeedResponse, Map<String, Object?>>>(
      _i34.GetFeedResponseJsonConverter());
  gh.singleton<_i30.JsonConverter<_i35.LogInResponse, Map<String, Object?>>>(
      _i36.LogInResponseJsonConverter());
  gh.singleton<
  ...
  gh.singleton<_i30.JsonConverter<_i41.LogOutResponse, Map<String, Object?>>>(
      _i42.LogOutResponseJsonConverter());
  gh.singleton<
          _i43.JsonConverter<_i44.RefreshTokenResponse, Map<String, Object?>>>(
  ...
  gh.singleton<_i43.JsonConverter<_i48.RegisterResponse, Map<String, Object?>>>(
      _i49.RegisterResponseJsonConverter());
  gh.singleton<
          _i30.JsonConverter<_i50.VerifyTokenResponse, Map<String, Object?>>>(
  ...
  gh.singleton<_i118.UserService>(_i118.UserService(
    keepFreshTokenService: gh<_i113.KeepFreshTokenService>(),
    userProvider: gh<_i85.UserProvider>(),
    endUserRepository: gh<_i117.EndUserRepository>(),
    staffUserRepository: gh<_i117.StaffUserRepository>(),
  ));
  gh.singleton<_i119.AccountService>(
    _i119.AccountService(
  ...
  await gh.singletonAsync<_i120.AuthService>(
    () {
      final i = _i120.AuthService(
        serverAvailabilityProvider: gh<_i116.ServerAvailabilityProvider>(),
        authProvider: gh<_i90.AuthProvider>(),
        tokenService: gh<_i114.TokenService>(),
        endUserRepository: gh<_i117.EndUserRepository>(),
        authExceptionProvider: gh<_i121.AuthExceptionProvider>(),
        deviceInfoService: gh<_i115.DeviceInfoService>(),
        keepFreshTokenService: gh<_i113.KeepFreshTokenService>(),
        authStatusProvider: gh<_i4.AuthStatusProvider>(),
      );
  ...
  gh.singleton<_i122.FeedService>(_i122.FeedService(
    keepFreshTokenService: gh<_i44.KeepFreshTokenService>(),
    feedProvider: gh<_i103.FeedProvider>(),
  ));
  gh.singleton<_i123.GoRouter>(routerModule.router(
    gh<_i29.GlobalKey<_i29.NavigatorState>>(),
    gh<_i124.AuthService>(),
  ));
  gh.singleton<_i125.HomeCoordinator>(
    _i126.ProdHomeCoordinator(goRouter: gh<_i123.GoRouter>())..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i127.HomeStore>(
      () => _i127.HomeStore(homeCoordinator: gh<_i125.HomeCoordinator>()));
  gh.singleton<_i124.LogInCoordinator>(
    _i128.ProdLogInCoordinator(
      goRouter: gh<_i123.GoRouter>(),
      authStatusProvider: gh<_i124.AuthStatusProvider>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i129.LogInStore>(() => _i129.LogInStore(
        authService: gh<_i8.AuthService>(),
        logInCoordinator: gh<_i130.LogInCoordinator>(),
        logInStringProvider: gh<_i55.LogInStringProvider>(),
      ));
  gh.singleton<_i124.MenuCoordinator>(
      _i131.ProdMenuCoordinator(goRouter: gh<_i123.GoRouter>()));
  gh.singleton<_i132.MenuStore>(
      _i132.MenuStore(menuCoordinator: gh<_i133.MenuCoordinator>()));
  gh.singleton<_i124.PostCoordinator>(
      _i134.ProdPostCoordinator(goRouter: gh<_i123.GoRouter>()));
  gh.singleton<_i124.RegisterCoordinator>(
    _i135.ProdRegisterCoordinator(
      goRouter: gh<_i123.GoRouter>(),
      authStatusProvider: gh<_i124.AuthStatusProvider>(),
    )..init(),
    dispose: (i) => i.dispose(),
  );
  gh.factory<_i136.RegisterStore>(() => _i136.RegisterStore(
        authService: gh<_i8.AuthService>(),
        registerCoordinator: gh<_i137.RegisterCoordinator>(),
        registerStringProvider: gh<_i68.RegisterStringProvider>(),
      ));
  gh.singleton<_i124.RulesCoordinator>(
      _i138.ProdRulesCoordinator(goRouter: gh<_i123.GoRouter>()));
  gh.factory<_i139.RulesStore>(() => _i139.RulesStore(
        rulesService: gh<_i140.RulesService>(),
        rulesCoordinator: gh<_i141.RulesCoordinator>(),
      ));
  gh.singleton<_i124.SettingsCoordinator>(
      _i142.ProdSettingsCoordinator(goRouter: gh<_i123.GoRouter>()));
  gh.singleton<_i143.SettingsStore>(_i143.SettingsStore(
    authService: gh<_i44.AuthService>(),
    settingsCoordinator: gh<_i144.SettingsCoordinator>(),
    settingsStringProvider: gh<_i76.SettingsStringProvider>(),
    accountService: gh<_i119.AccountService>(),
    mapster: gh<_i58.Mapster>(),
  ));
  gh.singleton<_i124.AccountSettingsCoordinator>(
      _i145.ProdAccountSettingsCoordinator(goRouter: gh<_i123.GoRouter>()));
  gh.factory<_i146.AccountSettingsStore>(() => _i146.AccountSettingsStore(
      accountSettingsCoordinator: gh<_i147.AccountSettingsCoordinator>()));
  gh.singleton<_i124.ChangePersonalInfoCoordinator>(
      _i148.ProdChangePersonalInfoCoordinator(goRouter: gh<_i123.GoRouter>()));
  gh.factory<_i149.ChangePersonalInfoStore>(() => _i149.ChangePersonalInfoStore(
        accountService: gh<_i150.AccountService>(),
        changePersonalInfoCoordinator:
            gh<_i151.ChangePersonalInfoCoordinator>(),
        changePersonalInfoStringProvider:
            gh<_i96.ChangePersonalInfoStringProvider>(),
      ));
  gh.singleton<_i124.CommentCoordinator>(
      _i152.ProdCommentCoordinator(goRouter: gh<_i123.GoRouter>()));
  gh.factory<_i153.CommentReplyStore>(() => _i153.CommentReplyStore(
        commentService: gh<_i16.CommentService>(),
        commentCoordinator: gh<_i154.CommentCoordinator>(),
        commentReplyStringProvider: gh<_i98.CommentReplyStringProvider>(),
        mapster: gh<_i58.Mapster>(),
      ));
  gh.factory<_i155.CommentStore>(() => _i155.CommentStore(
        commentReplyStore: gh<_i153.CommentReplyStore>(),
        commentService: gh<_i16.CommentService>(),
        commentCoordinator: gh<_i154.CommentCoordinator>(),
        commentStringProvider: gh<_i100.CommentStringProvider>(),
        mapster: gh<_i58.Mapster>(),
      ));
  gh.singleton<_i156.DevicesCoordinator>(
      _i157.ProdDevicesCoordinator(goRouter: gh<_i123.GoRouter>()));
  gh.singleton<_i158.DevicesStore>(_i158.DevicesStore(
    devicesCoordinator: gh<_i156.DevicesCoordinator>(),
    accountService: gh<_i119.AccountService>(),
    mapster: gh<_i58.Mapster>(),
  ));
  gh.singleton<_i124.FeedCoordinator>(
      _i159.ProdFeedCoordinator(goRouter: gh<_i123.GoRouter>()));
  gh.factory<_i160.FeedStore>(() => _i160.FeedStore(
        feedService: gh<_i122.FeedService>(),
        userService: gh<_i44.UserService>(),
        feedCoordinator: gh<_i161.FeedCoordinator>(),
        feedStringProvider: gh<_i105.FeedStringProvider>(),
        mapster: gh<_i58.Mapster>(),
      ));
  gh.factory<_i162.PostCommentStore>(() => _i162.PostCommentStore(
        commentService: gh<_i16.CommentService>(),
        commentCoordinator: gh<_i154.CommentCoordinator>(),
        postCommentStringProvider: gh<_i59.PostCommentStringProvider>(),
        mapster: gh<_i58.Mapster>(),
      ));
  gh.factory<_i163.PostStore>(() => _i163.PostStore(
        postCommentStore: gh<_i162.PostCommentStore>(),
        postService: gh<_i64.PostService>(),
        postCoordinator: gh<_i164.PostCoordinator>(),
        postStringProvider: gh<_i66.PostStringProvider>(),
        mapster: gh<_i58.Mapster>(),
      ));
  gh.singleton<_i165.CategoryStore>(_i165.CategoryStore(
    feedStore: gh<_i160.FeedStore>(),
...
class _$EnvModule extends _i166.EnvModule {}

class _$MapsterModule extends _i167.MapsterModule {}

class _$RouterModule extends _i168.RouterModule {}

class _$DeviceInfoPlusModule extends _i169.DeviceInfoPlusModule {}

class _$DioModule extends _i170.DioModule {}

class _$SecureStorageModule extends _i171.SecureStorageModule {}
